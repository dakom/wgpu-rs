...
sourcesIndex["naga"] = {"name":"","dirs":[{"name":"back","dirs":[{"name":"spv","files":["layout.rs","mod.rs","writer.rs"]}],"files":["mod.rs","msl.rs"]},{"name":"front","files":["mod.rs","spv.rs","wgsl.rs"]},{"name":"proc","files":["interface.rs","mod.rs","typifier.rs"]}],"files":["arena.rs","lib.rs"]};
